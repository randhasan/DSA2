...
public class LZW {
    ...
    public static void compress() {
        if (flushIfFull) //write the first bit of the compressed file
        {
        ...
        CompressionCodeBookInterface codebook = 
            new DLBCodeBook(9, 16); //changed minW and maxW when instantiating code books
    ...
    public static void expand() {
        if (BinaryStdIn.readInt(1) == 1) //read first bit of the compressed file
        {
            flushIfFull = true;
        }
        else
        ...
        ExpansionCodeBookInterface codebook = new ArrayCodeBook(9, 16); //changed minW and maxW when instantiating code books
